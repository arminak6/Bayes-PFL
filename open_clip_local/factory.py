...
def _get_hf_config(model_id, cache_dir=None):
    ...
    #config_path = "/data/jyafei/zhen/LogSAD/vit_L_14_hug_weight/open_clip_config.json"
...
def create_model(
    ...
    if has_hf_hub_prefix:
        ...
        #checkpoint_path = "/data/jyafei/zhen/LogSAD/vit_L_14_hug_weight/open_clip_pytorch_model.bin"
        config_path = download_pretrained_from_hf(model_id, filename='open_clip_config.json', cache_dir=cache_dir)
        #config_path = "/data/jyafei/zhen/LogSAD/vit_L_14_hug_weight/open_clip_config.json"
    ...
    if pretrained and pretrained.lower() == 'openai':
        ...
        if pretrained:
            ...
            if pretrained_cfg:
                # cache_dir = '/data/yizhou/VAND2.0/wgd/single_scale'
...
def create_model_and_transforms(
    ...
    model.visual.preprocess_cfg['resize_mode'] = 'squash'
